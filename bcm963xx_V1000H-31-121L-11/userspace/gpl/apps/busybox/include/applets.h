...
#define _BB_DIR_USR_SBIN _BB_DIR_SBIN
...
#endif
	APPLET_NOUSAGE("cpulogd", cpulogd_main, _BB_DIR_SBIN, _BB_SUID_NEVER)
#ifdef CONFIG_CROND
	...
	APPLET(flash_eraseall, flash_eraseall_main, _BB_DIR_BIN, _BB_SUID_NEVER)
#endif
#ifdef CONFIG_FOLD
...
#endif
// BRCM Begin
#ifdef CONFIG_SENDARP
	APPLET(sendarp, sendarp_main, _BB_DIR_BIN, _BB_SUID_NEVER)
#endif
// BRCM End
#ifdef CONFIG_SEQ
...
#endif
// BRCM Begin
#ifdef CONFIG_SYSINFO
	APPLET(sysinfo, sysinfo_main, _BB_DIR_BIN, _BB_SUID_NEVER)
#endif
// BRCM End
...
// BRCM Begin
#ifdef CONFIG_TFTPD
	APPLET(tftpd, tftpd_main,_BB_DIR_BIN, _BB_SUID_NEVER)
#endif
// BRCM End
#ifdef CONFIG_TIME
