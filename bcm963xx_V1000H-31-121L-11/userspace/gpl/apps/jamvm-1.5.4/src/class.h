...
#else
#define JAMVM_CLASSES "/usr/local/jamvm/share/jamvm/classes"
#define CLASSPATH_CLASSES "/usr/local/classpath/share/classpath/:/lib"
#endif

#define DFLT_BCP JAMVM_CLASSES":"CLASSPATH_CLASSES":/usr/local/jamvm/lib"
