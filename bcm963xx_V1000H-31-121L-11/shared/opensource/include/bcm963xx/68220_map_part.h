...
#ifndef __BCM68220_MAP_H
#define __BCM68220_MAP_H
...
#define UBUS_STAT_BASE              0xb0001A00  /* UBUS control/status registers */
...
typedef struct GpioControl {
    ...
    uint32      GPIOMode;                   /* 18 */
#define GPIO_MODE_LS_SPIS_MOSI      (1<<31)
#define GPIO_MODE_LS_SPIS_MOSO      (1<<30)
...
#define GPIO_MODE_LS_SPIS_SSB       (1<<17)
#define GPIO_MODE_LS_SPIS_CLK       (1<<16)
...
#define GPIO_MODE_HS_SPI_SS_5       (1<< 9)
#define GPIO_MODE_HS_SPI_SS_4       (1<< 8)
#define GPIO_MODE_ROBOSW_LED1       (1<< 5)
#define GPIO_MODE_ROBOSW_LED0       (1<< 4)
