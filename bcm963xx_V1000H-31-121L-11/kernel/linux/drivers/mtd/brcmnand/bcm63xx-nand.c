...
#ifdef AEI_CONFIG_JFFS
        bcm63XX_nand_parts[0].offset = (nvram.ulNandPartOfsKb[rootfs]+nvram.ulNandPartSizeKb[NP_BOOT]) *1024;
        bcm63XX_nand_parts[0].size = (nvram.ulNandPartSizeKb[rootfs]-nvram.ulNandPartSizeKb[NP_BOOT]) *1024;
...
#ifdef AEI_CONFIG_JFFS
        bcm63XX_nand_parts[4].offset = (nvram.ulNandPartOfsKb[rootfs]) * 1024;
        bcm63XX_nand_parts[4].size = nvram.ulNandPartSizeKb[NP_BOOT] * 1024;;
        bcm63XX_nand_parts[4].ecclayout = mtd->ecclayout;

        bcm63XX_nand_parts[5].offset = (nvram.ulNandPartOfsKb[rootfs_update]) * 1024;
